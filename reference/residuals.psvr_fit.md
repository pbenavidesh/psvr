...
of percentage errors near zero (Makridakis); the thesis applies it in
Ch. 7 Sec. 7.6.1 by excluding observations below a threshold before
pooling. Exclude at the point of aggregation, e.g.:
