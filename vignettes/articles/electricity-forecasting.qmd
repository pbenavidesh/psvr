...
```{r}
#| label: tuning
#| eval: !expr identical(file.exists("case-studies/results/electricity-tune-results.rds"), FALSE)

results_file <- "case-studies/results/electricity-tune-results.rds"

if (!file.exists(results_file)) {

  # TS baselines and LR use fit_resamples
  ...
  tune_all <- tryCatch({
    ...
    bind_rows(tune_mape, tune_ts, tune_lm)
