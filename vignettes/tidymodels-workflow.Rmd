...
evaluate each fold by MAPE.  The `rbf_sigma` search range is set data-adaptively
using `rbf_sigma_psvr_data()`, centred on the median pairwise distance in the
normalised feature space.  `rmspe_lssvr()` only solves a linear system, so 75
