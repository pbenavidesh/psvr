...
#' `Omega_s` by power iteration and, if the smallest is numerically negative,
#' adds a `mu * I` shift large enough to make the SMO Hessian provably PSD
#' (`>= delta_stab * I`). Returns the matrix untouched when it is already PSD,
#' which is the case for every kernel `make_kernel()` supplies. Implements
#' Theorem 2 of arXiv:2605.01446 v3, with the eigenvalue estimator corrected;
#' see below.
#'
